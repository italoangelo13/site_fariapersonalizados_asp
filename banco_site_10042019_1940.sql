...
INSERT INTO `parametros_gerais` (`ADSENSE_PROMOCAO`) VALUES 
 ('S');
...
CREATE TABLE `promocao` (
  ...
  `PROM_TEXTOCHAMADA` text NOT NULL,
...
INSERT INTO `promocao` (`PROM_CODIGOID`,`PROM_NOME_PROMOCAO`,`PROM_IMAGEM`,`PROM_DESCRICAO`,`PROM_DATAINICIO`,`PROM_DATAFIM`,`PROM_PERCENT_DESCONTO`,`PROM_DATACADASTRO`,`PROM_USER`,`PROM_TEXTOCHAMADA`) VALUES 
 (1,'Promoção de Páscoa','assets/img/Promocoes/promocao_pascoa.jpg','<ol>\r\n                                <li>Esta promoção somente será válida para os pedidos realizados ate as 23 horas e 59\r\n                                    minutos do dia 18 de Abril de 2019.</li>\r\n\r\n                                <li>Canecas e copos de Acrílico não fazem parte desta promoção, apenas Canecas de\r\n                                    polímero e Porcelana.</li>\r\n                                <li>Esta promoção não sofrerá prorrogação de tempo, encerrando-se no dia e horario ja\r\n                                    definidos.</li>\r\n                                <li>O tempo de Entrega dos produtos desta promoção será de 2 dias Uteis, contando tambem\r\n                                    o Sabado.</li>\r\n                                <li>Formas de Pagamento: Dinheiro, Cartão de Crédito e Débito, Pic Pay, Transferencia\r\n                                    Bancária.</li>\r\n                            </ol>','2019-02-28 00:00:00','2019-04-18 23:59:59',20,'2019-02-28 00:00:00','ADMIN','<h3>Sua páscoa pode ser mais especial, com presentes da Faria Personalizados.\r\n                                Adquira 2 canecas de polímero por 25 reais ou 1 Caneca de porcelana por 20 Reais.\r\n                                <br>\r\n                                Para Participar, confira as condições abaixo.\r\n                            </h3>');
...
INSERT INTO `slides` (`SLD_CODIGOID`,`SLD_CAMINHOIMG`,`SLD_ATIVO`,`SLD_NOME_BANNER`) VALUES 
 (1,'assets/img/banner/banner1.png','S','PROMOÇÃO DE PASCOA 1'),
 (2,'assets/img/banner/banner2.png','S','PROMOÇÃO DE PASCOA 2');
